                                ...
                                <div className="rightNav" style={{ display: "flex", marginLeft: "auto" }}>
                                    ...
                                    {/* ===================================================userIcon================================================================= */}
                                                ...
                                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <li><a className="dropdown-item" href='#'><Link to="/userProfile" style={{color: "black"}}>Your Profile</Link></a></li>
                                                    <li><a className="dropdown-item" href='#'><Link to="/accountSetting" style={{color: "black"}}>Account Setting</Link></a></li>
                                                    <li><a className="dropdown-item" href='#' onClick={()=>signout()}><Link to="/" style={{color: "black"}}>LogOut</Link></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        {/* ========================================================Buttons============================================================ */}
                    ...
                    <div className="bgForm">
                        ...
                        <div className="form-container">
                            ...
                            <form id="log" onSubmit={handleSubmit}>
                                ...
                                <div className="inpt mt-3">
                                    <input type='text' placeholder="Input to be deleted" className="form-control"  />
                                </div>
                                <div className="inpt mt-3">
