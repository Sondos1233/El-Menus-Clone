            ...
            {/* <div class="box-disArear m-2" > */}
                <div>
                    {/* <div class="slide__content"> */}
                        {/* <div class="slide-img"> */}
                            <img
                            src={'https://s3-eu-west-1.amazonaws.com/elmenusv5-stg/Normal/12d9a1f1-bb97-4d31-92a2-821f32c4798f.jpg'} 
                            alt="" style={{height: "300px", width: "100%"}}/>
                            <div class="detail-box ">
                            <img
                                src={'https://s3-eu-west-1.amazonaws.com/elmenusv5-stg/Thumbnail/dc5d6efc-2580-11e8-add5-0242ac110011.jpg'}
                            ...
                            <div class="px-3">
                                ...
                                <a href="#" class="meal-kind">{props.ResName}Burger King</a>
                                <div class="d-flex">
